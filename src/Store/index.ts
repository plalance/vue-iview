...
export const store = new Vuex.Store({
    ...
    actions: {
        ...
        connectFakeUser: (store, fakeConfig) => {
            ...
            jm.addDataProperty("firstname", "Lara");
            jm.addDataProperty("display_name", "Lara Clette");
            jm.addDataProperty("lastname", "Clette");
            jm.addDataProperty("email", "maquette@cerp-rrm.com");
            jm.addDataProperty("company_name", "Siège");


            if (!fakeConfig) {
                jm.addDataProperty("company_id", "00");
                jm.addArrayDataProperty("group", ["S-1-5-21-1898398884-2118664892-1232828436-13283", "group2"]);
            } else {
